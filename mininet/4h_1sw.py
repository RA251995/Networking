#
# https://github.com/sachinites/SocketProgrammingMininet/blob/master/mininetTopologies/4h_1sw.py
#
...
if __name__ == "__main__":
    ...
    h1.cmd("ip route add default via 10.0.20.254 dev h3-eth0")
    h2.cmd("ip route add default via 10.0.20.254 dev h4-eth0")
